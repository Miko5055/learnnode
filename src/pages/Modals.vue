...
<template>
    <div class="container">
        <section>
           ...
           <button class="button is-warning" @click="modalActive3=true">Modal 3 Active</button>
        </div>
        </section>
    </div>
 
    <ImgModal :active="modalActive" @close ="modalActive = false" url ="https://picsum.photos/seed/goomn/200/300"></ImgModal>
    <ImgModal :active="modalActive2" @close ="modalActive2 = false" url = "https://picsum.photos/seed/paic/200/300"></ImgModal>
